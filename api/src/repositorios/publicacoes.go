...
// BuscarPorID retorna uma única publicação do banco de dados
...
// Buscar retorna as publicações dos usuários seguidores e também do próprio usuário que fez a requisição
...
// BuscarPorUsuario retorna todas as publicações de um usuário específico
